...
<div class="archive-list-post list-style">
    <div class="read-single color-pad">
        <div id="single-post-list" class="data-bg read-img pos-rel col-2 float-l read-bg-img af-sec-list-img" data-background="<?php echo esc_url($url); ?>">
            <?php if (!empty($url)) : ?>
                <img id="single-post-img" src="<?php echo esc_url($url); ?>">
            <?php endif; ?>
