                ...
                <div class="section-wrapper">
                    <div class="af-double-column list-style af-container-row clearfix">
                        <?php
                                    ...
                                    $featured_posts = newsphere_get_posts_rand_post($newsphere_number_of_featured_news, $newsphere_featured_category);
                                ...
                                <div class="col-3 pad float-l " data-mh="af-feat-list">
                                    <div class="read-single-featured color-pad">
                                        <div class="read-details col-75 float-r pad color-tp-pad">
                                            <!-- <div class="read-categories" style="text-align:left">                                                
                                                <?php newsphere_post_categories(); ?>
                                            </div> -->                                            
                                            <div class="read-title-featured" style="text-align:left">
                                                <h4>
